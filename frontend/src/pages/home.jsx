        ...
        <div className="w-screen h-screen flex justify-center items-center bg-gray-100">
            ...
            >
                <img
                    src={logoImg}
                    alt="logo"
                    className="w-60 absolute top-[200px] left-1/2 -translate-x-1/2"
                    style={{ zIndex: 10 }}
                />
                <div className="absolute bottom-[90px] left-1/2 -translate-x-1/2 flex flex-col w-full items-center">
