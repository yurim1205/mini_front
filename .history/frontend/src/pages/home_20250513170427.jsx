        ...
        <div className="w-screen h-screen flex justify-center items-center bg-gray-100">
            <div className="relative h-screen flex flex-col items-center justify-center bg-gradient-to-b from-white via-[#6699E6] to-[#0033ff] max-w-[360px] w-full">
                <img
                    src={logoImg}
                    alt="logo"
                    className="w-60 absolute top-[100px] left-1/2 -translate-x-1/2"
                    style={{ zIndex: 10 }}
                />
                <div className="absolute bottom-[100px] left-1/2 -translate-x-1/2 flex flex-col w-full items-center">
