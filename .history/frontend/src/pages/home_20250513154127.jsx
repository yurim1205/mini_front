...
function Home() {
    ...
    return(
        <div className="w-sreen h-screen flex flex-col items-center justify-center bg-gradient-to-b from-white via-[#6699E6] to-[#0033ff] max-w-[360px] mx-auto">
        <img src={logoImg} alt="logo" className="w-36 mb-10" />
