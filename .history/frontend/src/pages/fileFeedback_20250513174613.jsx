  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gray-100">
      <div
        ...
        style={{
          background: "linear-gradient(to bottom, #6699E6 0%, #6699E6 40%, #b3cfff 100%)"
        }}
      >
        ...
        <img
          src={owlImg}
          alt="owl"
          className="w-32 mx-auto mt-16 "
        />

        <div
          className="rounded-t-2xl rounded-b-none shadow-md w-full px-6 py-6 mt-2 flex flex-col items-center min-h-[320px]"
          style={{
            background: "linear-gradient(to bottom, #b3cfff 0%, #e0eaff 60%, #b3cfff 100%)"
          }}
        >
          {/* 파일 업로드 부분 */}
