  ...
  return (
    <div className="w-screen h-screen flex justify-center items-center bg-gray-100">
      ...
      >
        ...
        <div
          className="rounded-t-2xl rounded-b-none shadow-md w-full px-6 py-6 mt-2 flex flex-col items-center min-h-screen"
          style={{
        ...
        >
          ...
          <ul className="text-xs text-gray-500 w-full list-disc pl-4">
